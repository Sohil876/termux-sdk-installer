...
install() {
  ...
  if [[ "${CURRENT_SHELL}" == "bash" ]]; then
    ...
    echo -e "${green}You will need to manually export env vars JAVA_HOME and ANDROID_SDK_ROOT on every session to use sdk, or add them to your shell profile manually:${nocol}"
